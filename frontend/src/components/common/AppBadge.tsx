...
const toneClasses: Record<AppBadgeTone, string> = {
  ...
  confirmed: 'border-blue-200/20 bg-blue-950/40 text-blue-100',
  cancelled: 'border-red-300/20 bg-red-400/10 text-red-200',
  completed: 'border-blue-200/20 bg-blue-950/40 text-blue-100',
  noShow: 'border-red-300/20 bg-red-400/10 text-red-200',
  active: 'border-amber-200/25 bg-amber-100/10 text-amber-100',
